...
<section id="login">
      <div class="container">
        ...
        <div class="form-group floating-label-form-group controls mb-0 pb-2">
          <input type="username" class="form-control" size="50" style = "margin: 5px" placeholder="Username" required="required">
          <p class="help-block text-danger"></p>
          </div>
          </div>
        <div class="control-group">
        <div class="form-group floating-label-form-group controls mb-0 pb-2">
        <input type="password" class="form-control" size="50" style = "margin: 5px" placeholder="Password" required="required">
        <p class="help-block text-danger"></p>
        </div>
        </div>
    <a class="btn btn-secondary btn-l js-scroll-trigger" type="submit">Login</a>
    <p>
