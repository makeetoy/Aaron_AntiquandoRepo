      ...
      <div class="container">
        ...
        <?php include('errors.php'); ?>
                ...
                <div class="form-group floating-label-form-group controls mb-0 pb-2">
                  <input  type="username" class="form-control" name="username" size="50" style = "margin: 5px" placeholder="Username" value="<?php echo $username; ?>" required="required" data-validation-required-message="Please enter a username.">
                ...
                <p class="help-block text-danger"></p>
                 ...
                 <div class="input-group">
                 <div class="form-group floating-label-form-group controls mb-0 pb-2">
                 <input type="email" class="form-control" name="email" size="50" style = "margin: 5px" placeholder="Email Address" value="<?php echo $email; ?>" required="required" data-validation-required-message="Please enter a email.">
                 <p class="help-block text-danger"></p>
                </div>
                </div>
